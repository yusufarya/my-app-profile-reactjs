    ...
    return (
        ...
        <div className='flex justify-center w-full lg:mx-0 md:mx-0 sm:mx-0 mx-0 px-0'>
            <div className='bg-grey-50 mx-1 px-1 lg:mx-0 lg:px-0 md:mx-1 md:px-1 sm:mx-5 sm:px-5 w-full lg:w-2/3 md:w-2/3 sm:w-2/3'>
                <h1 className="text-left ms-3 mt-1 lg:mt-2 md:mt-2 sm:mt-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-slate-100 sm:text-4xl Font-PublicSans-Bold ">Yusuf Aryadilla</h1>
                <br/>
                <h1 className="text-left ms-3 mt-1 lg:mt-4 md:mt-3 sm:mt-2 text-2xl tracking-tight text-gray-900 dark:text-slate-100 lg:text-4xl md:text-3xl sm:text-4xl Font-PublicSans-Bold">👋 Hi, everyone how are you ?</h1>
                <br/>
                <p className="mt-3 mx-3 text-base text-gray-800 dark:text-slate-100 Font-PublicSans-Regular "
                    data-aos="fade-up"
                    data-aos-offset="50"
                ...
                <div className="social-media mx-2 pt-5 flex">
                    <a href="" className='text-gray-800 dark:text-slate-100 mx-2'><AiFillGithub className='h-4 w-4 lg:h-6 lg:w-6 md:h-5 md:w-5' /></a>
                    <a href="" className='text-gray-800 dark:text-slate-100 mx-2'><AiFillLinkedin className='h-4 w-4 lg:h-6 lg:w-6 md:h-5 md:w-5' /></a>
                    <a href="" className='text-gray-800 dark:text-slate-100 mx-2'><AiOutlineInstagram className='h-4 w-4 lg:h-6 lg:w-6 md:h-5 md:w-5' /></a>
                    <a href="" className='text-gray-800 dark:text-slate-100 mx-2'><AiOutlineTwitter className='h-4 w-4 lg:h-6 lg:w-6 md:h-5 md:w-5' /></a>
                    <a href="" className='text-gray-800 dark:text-slate-100 mx-2'><AiTwotoneMail className='h-4 w-4 lg:h-6 lg:w-6 md:h-5 md:w-5' /></a>
                </div>
            </div>
        </div>
        </>
