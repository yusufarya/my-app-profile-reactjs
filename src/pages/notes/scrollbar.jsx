    ...
    return (
        ...
        <div className='lg:mx-5 md:mx-4 sm:mx-4 lg:px-4 md:px-4 sm:px-4 mx-1 px-1 flex justify-center w-full'>
            <div className='bg-grey-50 mx-0 px-0 lg:mx-5 lg:px-5 md:mx-5 md:px-5 sm:mx-5 sm:px-5 w-full lg:w-3/4 md:w-3/4 sm:w-3/4'>
                ...
                <h1 className="text-left ms-3 mt-1 lg:mt-2 md:mt-2 sm:mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-3xl font-sans ">Custom Scrollbar</h1>
                <p className="ms-4 mt-3">Define your own custom scroll bar</p>
                        <br/>
                ...
                <h2 className="mt-3 mx-2 text-3xl font-bold">Reference</h2>
                <ul className="ms-3 mt-3 text-md">
                    <li className="font-semibold"> &#9679; W3Schools : &nbsp; </li>
                    ...
                    <li className="font-semibold"> &#9679; MDN : &nbsp; </li>
