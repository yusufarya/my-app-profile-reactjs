...
function Main() {
    ...
    useEffect(() => {
        AOS.init();  // Initialize AOS after component mounts
    ...
    return (
        <>
            {/* <Topbar/> */}
            {deviceType === 'Desktop' &&
                <div className="flex justify-center h-20 relative z-50">
                    <div className="grid grid-rows-1 fixed shadow-sm pb-16 top-0 w-full lg:w-2/3 md:w-2/3 sm:w-2/3 h-14 rounded-md my-1 lg:my-1 md:my-1 sm:my-1 bg-neutral-50 dark:bg-black dark:text-white"
